...
public class Ghost : MonoBehaviour, IPlayable
{
    ...
    #region Properties: Internal Parts
    [Header("Sprite Renderers ")]
    public SpriteRenderer body;
    public SpriteRenderer eyes;
    public SpriteRenderer blue;
    public SpriteRenderer white;
    public MeshRenderer spotlight;
    #endregion

    #region Properties: Ghost Properties
    ...
    #region Properties: Model Settings
    [Header("Model Settings")]
    public PlayerCharacter characterSlot;
    public GameObject worldPrefab;
    public Material initalWorldMaterial;
    public Material worldMaterial { get; private set; }
    public GameObject worldObject { get; private set; } = null;
    #endregion

    #region Properties: Ghost Tagging
    [Header("Ghost Tagging")]
    public bool isTagGhost = false;
    ...
    private void Awake()
    {
        ...
        worldMaterial = initalWorldMaterial;
    ...
    IEnumerator Start()
    {
        ...
        worldObject = Instantiate(worldPrefab, _worldOrigin, Quaternion.Euler(Vector3.zero), GameManager.Instance.GetWorldViewCache().transform);
    ...
    public void Tag(Ghost target = null)
    {
        if (target)
        {
            ...
            worldMaterial = target.initalWorldMaterial;
